...
resolve = {arg, cmd ->
    ...
    CommandLine cmd2 = new org.apache.commons.cli.GroovyInternalPosixParser().parse(options, arg[1..-1] as String[], true);
    arg = cmd2.args
...
CommandLine cmd = new org.apache.commons.cli.GroovyInternalPosixParser().parse(options, args, true);
